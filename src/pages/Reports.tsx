      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 max-w-5xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <Button
              variant={showCrossReport ? "default" : "outline"}
              size="sm"
              onClick={() => setShowCrossReport(!showCrossReport)}
            >
        ...
        {showCrossReport ? (
          <CrossReportView
            crossReportData={crossReportData}
            crossReportPeriod={crossReportPeriod}
            setCrossReportPeriod={setCrossReportPeriod}
            projects={projects}
          />
        ) : (
          <>
